<System.ComponentModel.RunInstaller(True)> Partial Class ProjectInstaller
    ...
    Private Sub InitializeComponent()
        ...
        'ServiceInstaller1
        '
        Me.ServiceInstaller1.Description = "Windows service to run WaferDataAPI"
        Me.ServiceInstaller1.DisplayName = "WaferDataAPIService"
        Me.ServiceInstaller1.ServiceName = "WaferDataAPIService"
